...
import UpdateContactModal from '~/components/contact-modals/modal-update-contact'
import DeleteContactModal from '~/components/contact-modals/modal-delete-contact'
                      ...
                      <div className="flex flex-col w-full mt-5 px-5 text-scheme-sky space-y-10">
                        ...
                        <div className="flex flex-row w-full space-x-1">
                          <div className="flex flex-col w-full max-w-sm space-y-1">
                            <div className="flex flex-col w-full px-5 py-3 rounded-lg text-scheme-pale bg-scheme-dark space-y-2">
                              <span className="font-bold text-xl">Intro</span>
                              <span className="font-normal text-base">{ contact.description }</span>
                            </div>
                            <div className="flex flex-col w-full px-5 py-3 rounded-lg text-scheme-pale bg-scheme-dark">
                              <span className="font-bold text-lg">{ contact.phone }</span>
                              <span className="font-normal text-sm text-scheme-sky">Phone</span>
                            </div>
                            <div className={`${contact.email ? 'flex flex-col w-full px-5 py-3 rounded-lg text-scheme-pale bg-scheme-dark ' : 'hidden'}`}>
                              <span className="font-bold text-lg">{ contact.email }</span>
                              <span className="font-normal text-sm text-scheme-sky">Email</span>
                            </div>
                          </div>
                          <div className="flex flex-col w-full max-w-full space-y-1">
                            <div className="flex w-full px-5 py-3 rounded-lg text-scheme-pale bg-scheme-dark">
                              <span className="font-bold text-xl">Basic Information</span>
                            </div>
                            <div className="flex flex-col w-full px-5 py-3 rounded-lg text-scheme-pale bg-scheme-dark">
                              <div className={`${contact.address ? 'flex flex-col border-b border-scheme-mid py-3 w-full' : 'hidden'}`}>
                                <span className="font-bold text-lg">{ contact.address }</span>
                                <span className="font-normal text-sm text-scheme-sky">Home Address</span>
                              </div>
                              <div className={`${contact.birthday ? 'flex flex-col border-b border-scheme-mid py-3 w-full' : 'hidden'}`}>
                                <span className="font-bold text-lg">{ contact.birthday }</span>
                                <span className="font-normal text-sm text-scheme-sky">Birthday</span>
                              </div>
...
function FacebookIcon() {
  return (
    <svg className="w-8 h-8 fill-current text-scheme-dark transition ease-in-out duration-300 transform hover:scale-90" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
...
function TiktokIcon() {
  return (
    <svg className="w-8 h-8 fill-current text-scheme-dark transition ease-in-out duration-300 transform hover:scale-90" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
