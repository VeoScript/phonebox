                ...
                <form onSubmit={handleSubmit(updateContact)} className="flex flex-col w-full mt-5 space-y-2">
                  <div className="flex flex-row w-full space-x-2">
                    ...
                    <div className="flex flex-col w-full space-y-2">
                      ...
                      <div className="form-control w-full">
                        <input type="text" setValue={"slug"} name="slug" {...register("slug", { required: true })} className="bg-gray-100 text-[#333] text-base px-5 py-3 w-full rounded-lg focus:outline-none disabled:cursor-not-allowed disabled:opacity-50" placeholder="Slug" disabled={ isSubmitting } />
