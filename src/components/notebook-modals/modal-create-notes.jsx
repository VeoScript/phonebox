                ...
                <form onSubmit={handleSubmit(createContact)} className="flex flex-col w-full mt-5 space-y-2">
                  <div className="flex flex-row w-full space-x-2">
                    <div className="flex flex-col w-full space-y-2">
                      ...
                      <div className="flex flex-row form-control w-full bg-white text-[#333]">
                        <Controller 
                          control={control}
                          name="note"
                          render={({field}) => (
                        ...
                        />
                        { errors.note && <span className="text-xs text-red-500 font-medium pt-0.5">{ errors.note.message }</span> }
                      </div>
